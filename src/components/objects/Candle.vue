<script setup>
	...
	const candleLightUpSound = ref(null);
	...
	const lightCandle = () => {
		...
		candleLightUpSound.value.components.sound.playSound();
...
<template>
	<a-entity
		...
		<a-entity ref="candleLightUpSound" sound="poolSize: 4; src: #light-up-candle; volume: 5" position="0 0 0"></a-entity>
	</a-entity>
</template>
